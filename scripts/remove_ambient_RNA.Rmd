...
packages <- c("dplyr", "knitr", "ggplot2", "Rtsne", "cowplot", "Seurat", "limma", "tidyr", "DropletUtils", "SoupX", "DoubletFinder")
...
# Save the results
```{r}
print(paste0("Saving results to SoupX/", snakemake@params$sample))
dir.create(file.path(getwd(), "SoupX"), showWarnings = FALSE)
path_to_save <- paste0("SoupX/", snakemake@params$sample)
